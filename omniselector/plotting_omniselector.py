...
"""
Omniselector Plotting - Funzioni per creazione e aggiornamento grafici
"""
...
from .core_omniselector import ompd_power, ompd_power_short, w_eff, _format_time_label, TCPMAX
...
def plot_ompd_curve(ax, x_data, y_data, params, theme="Forest Green"):
    ...
    ax.set_title("Omniselector Curve", color=text_color, fontsize=14)
